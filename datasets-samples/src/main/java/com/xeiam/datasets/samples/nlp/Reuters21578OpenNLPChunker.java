...
import com.xeiam.datasets.common.nlp.OpenNLPChunkerUtils;
 ...
 * @author timmolter
 */
public class Reuters21578OpenNLPChunker {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      String[] chunks = OpenNLPChunkerUtils.chunk(reuters21578List.get(0).getBody());
